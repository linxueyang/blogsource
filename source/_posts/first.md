---
title: Hexo搭建过程
date: 2020-03-24 14:08:21
top: true
cover: true
img: /medias/featureimages/0.jpg
coverImg: /medias/featureimages/0.jpg
categories: Hexo
summary: 第一次使用hexo搭建过程分享
# password: a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3
tags:
  - Hexo
  - Markdown
---
<img src="first/logo.jpg" width = "200" height = "200"  align=center >
...
> 5. 登陆你的github帐户。点击你的头像，然后 Settings -> 左栏点击 SSH and GPG keys -> 点击 New SSH key新建公钥title可以随便输key就是你刚刚新建的公钥
> 6. 可以测试下：ssh git@github.com如果输出Hi xxx! You've successfully authenticated, but GitHub does not # provide shell access. Connection to github.com closed.说明成功了
## Hexo
- 安装Hexo
```bash
...
> 1. 登录个人github。
> 2. 创建repository   Repository name为 个人账号名称如：`linxueyang.github.io`
> 3. 修改 `_config.yml` 文件 
```yaml
deploy:
   type: git
   repo: git@github.com:linxueyang/linxueyang.github.io.git  #ssh方式
   branch: master
```   
> 4. 建立bat文件快速执行推送，在hexo目录下修改package.json，新增  `"start": "hexo clean & hexo deploy"` ,新建bat文件：`npm run start`
> 5. 域名映射：将域名映射到github,打开域名解析，添加记录，记录类型选CHAME，值填写githubpage地址如：`linxeuyang.github.io`
> 6. 打开github GitHub Pages选项将域名填入，github将自动生成CHAME文件，如果每次推送会把CHAME覆盖，则将CHAME拷贝到hexo的source目录下

## 部署到个人服务器
将文件夹public下的静态文件部署到服务器则可以
